...
export const buildAwsCloudDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "aws_cloud", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "aws_cloud", checkpoint: planningOpt.checkpoint }) : null,
