...
export const buildGcpCloudDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "gcp_cloud", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "gcp_cloud", checkpoint: planningOpt.checkpoint }) : null,
