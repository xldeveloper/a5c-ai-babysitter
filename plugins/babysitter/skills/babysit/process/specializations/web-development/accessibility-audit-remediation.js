...
export const accessibilityAuditTask = defineTask('a11y-audit', (args, taskCtx) => ({ kind: 'agent', title: `Accessibility Audit - ${args.projectName}`, agent: { name: 'a11y-auditor', prompt: { role: 'Accessibility Auditor', task: 'Audit for WCAG compliance', context: args, instructions: ['1. Run automated scans', '2. Manual testing', '3. Check color contrast', '4. Test keyboard navigation', '5. Check screen readers', '6. Test focus management', '7. Check forms', '8. Test images', '9. Check headings', '10. Document findings'], outputFormat: 'JSON with audit results' }, outputSchema: { type: 'object', required: ['results', 'issues', 'artifacts'], properties: { results: { type: 'object' }, issues: { type: 'array' }, artifacts: { type: 'array' } } } }, io: { inputJsonPath: `tasks/${taskCtx.effectId}/input.json`, outputJsonPath: `tasks/${taskCtx.effectId}/result.json` }, labels: ['web', 'accessibility', 'audit'] }));
