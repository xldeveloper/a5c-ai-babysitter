...
export const tailwindSetupTask = defineTask('tailwind-setup', (args, taskCtx) => ({ kind: 'agent', title: `Tailwind Setup - ${args.projectName}`, agent: { name: 'tailwind-architect', prompt: { role: 'Tailwind Architect', task: 'Configure Tailwind CSS', context: args, instructions: ['1. Install Tailwind CSS', '2. Configure PostCSS', '3. Set up tailwind.config', '4. Configure content paths', '5. Set up plugins', '6. Configure presets', '7. Set up PurgeCSS', '8. Configure safelist', '9. Set up IDE integration', '10. Document setup'], outputFormat: 'JSON with Tailwind setup' }, outputSchema: { type: 'object', required: ['config', 'artifacts'], properties: { config: { type: 'object' }, artifacts: { type: 'array' } } } }, io: { inputJsonPath: `tasks/${taskCtx.effectId}/input.json`, outputJsonPath: `tasks/${taskCtx.effectId}/result.json` }, labels: ['web', 'tailwind', 'setup'] }));
